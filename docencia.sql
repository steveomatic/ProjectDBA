...
CREATE VIEW Datos_Alumno AS
  SELECT a.nombre, a.apellido1, a.apellido2, a.dni, a.fecha_nacimiento, asig.nombre, m.curso_academico
  FROM alumno a, matricula m, asignatura asig
  WHERE a.alumno_id = m.alumno_id AND m.asignatura_id = asig.asignatura_id;
