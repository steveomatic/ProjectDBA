...
create sequence asignatura_seq start with 0 increment by 1;
create sequence alumno_seq start with 0 increment by 1;
create sequence ejercicio_seq start with 0 increment by 1;
create sequence profesor_seq start with 0 increment by 1;
create sequence relacion_seq start with 0 increment by 1;
create sequence usuario_seq start with 0 increment by 1;

INSERT INTO usuario VALUES(usuario_seq.NEXTVAL,'Godel');
INSERT INTO usuario VALUES(usuario_seq.NEXTVAL,'Russell');

INSERT INTO asignatura VALUES(asignatura_seq.NEXTVAL, 'ABD', 'Admin. Base de datos', '2cuat',50,100);
INSERT INTO asignatura values(asignatura_seq.NEXTVAL,'BD','Bases de Datos','1cuat',50,100);
INSERT INTO alumno VALUES (alumno_seq.NEXTVAL, '12345678A', 'Haritz', 'Puerto', 'San Román', '0001', SYSDATE, TO_DATE('1994/10/26', 'yyyy/mm/dd'));
insert into alumno values(alumno_seq.NEXTVAL,'12345679B','Felipe','Sulser','Larraz','0002',SYSDATE,TO_DATE('1993/10/16', 'yyyy/mm/dd'));
INSERT INTO matricula VALUES('14/15', 'A', 1, 1, 1);
insert into matricula VALUES('14/15','A',2,2,2);
INSERT INTO ejercicio VALUES(ejercicio_seq.NEXTVAL, 1, 'Muestra sysdate', 'SELECT sysdate FROM dual;', 0, 1);
INSERT into relacion VALUES (relacion_seq.NEXTVAL,1,1,1);
INSERT INTO calif_ejercicio VALUES(1,1,1,1,1, 'skfjlsdf');
INSERT INTO ejercicio VALUES(ejercicio_seq.NEXTVAL,1,'Muestra tu usuario', 'Select user from dual', 0,1);
INSERT INTO ejercicio VALUES(ejercicio_seq.NEXTVAL,1,'bla bla', 'sol', 0,1);
INSERT INTO ejercicio VALUES(ejercicio_seq.NEXTVAL,1,'bla bla', 'sol', 0,1);
INSERT INTO ejercicio VALUES(ejercicio_seq.NEXTVAL,1,'bla bla', 'sol', 0,1);
...
INSERT INTO ejercicio VALUES(ejercicio_seq.NEXTVAL,1,'bla bla', 'sol', 0,1);
INSERT INTO ejercicio VALUES(ejercicio_seq.NEXTVAL,1,'bla bla', 'sol', 0,1);
INSERT into relacion VALUES (relacion_seq.NEXTVAL,2,1,1);
